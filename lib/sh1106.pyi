...
class SH1106(FrameBuffer):
    ...
    def text_multiline(self, text: str, x: int, y: int, color: int = 1, dy: int = 10) -> None:
        """
        Draw multi-line text on the display, splitting on '\\n'.

        :param text: String to draw (may contain newlines).
        :param x: X-coordinate of the top-left corner.
        :param y: Y-coordinate of the top-left corner.
        :param color: Text color (1 for white, 0 for black).
        :param dy: Vertical spacing between lines.
        """
        ...
